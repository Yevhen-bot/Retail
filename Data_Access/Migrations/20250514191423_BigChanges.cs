    ...
    public partial class BigChanges : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildingClient", x => new { x.BuildingsId, x.ClientsId });
                    table.ForeignKey(
                        name: "FK_BuildingClient_Buildings_BuildingsId",
                        column: x => x.BuildingsId,
                        principalTable: "Buildings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BuildingClient_Clients_ClientsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Preferences", x => new { x.ClientId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuildingClient_ClientsId",
                table: "BuildingClient",
                column: "ClientsId");
